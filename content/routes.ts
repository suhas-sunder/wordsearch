...
export const corePages: SitePage[] = [
  ...
  },
  {
    ...
    description: "Browse worksheet-ready word searches with subject collections, name and date lines, word banks, and answer keys.",
    intro: "This collection is organized for teachers, homeschoolers, tutors, and substitute plans.",
